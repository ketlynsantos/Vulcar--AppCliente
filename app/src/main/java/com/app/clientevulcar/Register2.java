...
public class Register2 extends AppCompatActivity {
    public EditText edtEndereco, edtNum, edtComp, edtBairro, edtCidade, edtUF, edtCep;
    ...
    private Boolean validationRegister(String endereco, String num, String bairro,
